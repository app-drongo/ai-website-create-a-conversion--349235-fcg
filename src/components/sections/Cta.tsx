...
export default function CTA() {
  const stats = [
    { value: "200+", label: "SAP Implementations", icon: Factory },
    { value: "99.5%", label: "System Uptime", icon: Shield },
    { value: "40%", label: "Average Efficiency Gain", icon: TrendingUp },
    { value: "24/7", label: "Technical Support", icon: Settings }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join industry-leading manufacturers who have transformed their operations with our SAP ERP solutions. 
                Start your digital transformation journey with a comprehensive assessment.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by manufacturing leaders across industries
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Comprehensive system evaluation at no cost
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Industry-tested implementation framework
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Continuous optimization and technical assistance
              </p>
            </div>
          </div>
        </div>
